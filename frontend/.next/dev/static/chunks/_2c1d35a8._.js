...
"[project]/src/app/project/[id]/orchestrator/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const demoDecisions = [
    {
        step: "init",
        message: "Validating project parameters",
        messageAr: "التحقق من معايير المشروع"
    },
    {
        step: "init",
        message: "Loading regional building codes",
        messageAr: "تحميل أكواد البناء المحلية"
    },
    {
        step: "arch",
        message: "Generating floor plan layout",
        messageAr: "إنشاء تخطيط المخطط"
    },
    {
        step: "arch",
        message: "Optimizing core placement for efficiency",
        messageAr: "تحسين موقع النواة للكفاءة"
    },
    {
        step: "arch",
        message: "Calculating facade window-to-wall ratio",
        messageAr: "حساب نسبة النافذة للجدار"
    },
    {
        step: "struct",
        message: "Designing moment frame system",
        messageAr: "تصميم نظام الإطار الزمني"
    },
    {
        step: "struct",
        message: "Verifying lateral load resistance",
        messageAr: "التحقق من مقاومة الحمل الجانبي"
    },
    {
        step: "mep",
        message: "Routing HVAC ductwork",
        messageAr: "توجيه مجاري التكييف"
    },
    {
        step: "mep",
        message: "Placing electrical distribution panels",
        messageAr: "وضع لوحات التوزيع الكهربائية"
    },
    {
        step: "sim",
        message: "Running energy simulation",
        messageAr: "تشغيل محاكاة الطاقة"
    },
    {
        step: "sim",
        message: "Analyzing structural performance",
        messageAr: "تحليل الأداء الهيكلي"
    },
    {
        step: "package",
        message: "Generating IFC model",
        messageAr: "إنشاء نموذج IFC"
    },
    {
        step: "package",
        message: "Creating review package",
        messageAr: "إنشاء حزمة المراجعة"
    }
];
function OrchestratorPage() {
    ...
    const { project, setProject } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$project$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProjectStore"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrchestratorPage.useEffect": ()=>{
            const loadProject = {
                "OrchestratorPage.useEffect.loadProject": async ()=>{
            ...
            }["OrchestratorPage.useEffect.loadProject"];
            loadProject();
        }
    }["OrchestratorPage.useEffect"], [
        projectId,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrchestratorPage.useEffect": ()=>{
            ...
            const decisionsForStep = demoDecisions.filter({
                "OrchestratorPage.useEffect.decisionsForStep": (d)=>d.step === steps[currentStep]?.id
            }["OrchestratorPage.useEffect.decisionsForStep"]);
            // Add decisions gradually
            decisionsForStep.forEach({
                "OrchestratorPage.useEffect": (decision, i)=>{
                    setTimeout({
                        "OrchestratorPage.useEffect": ()=>{
                            setDecisions({
                                "OrchestratorPage.useEffect": (prev)=>[
                                        ...prev,
                                        decision
                                    ]
                            }["OrchestratorPage.useEffect"]);
                        }
                    }["OrchestratorPage.useEffect"], stepDuration * 1000 * (i + 1) / (decisionsForStep.length + 1));
                }
            }["OrchestratorPage.useEffect"]);
            // Update metrics
            const metricsInterval = setInterval({
                "OrchestratorPage.useEffect.metricsInterval": ()=>{
                    setMetrics({
                        "OrchestratorPage.useEffect.metricsInterval": (prev)=>({
            ...
            }["OrchestratorPage.useEffect.metricsInterval"], 1000);
            // Move to next step
            const timeout = setTimeout({
                "OrchestratorPage.useEffect.timeout": ()=>{
                    if (currentStep < steps.length - 1) {
                        setCurrentStep({
                            "OrchestratorPage.useEffect.timeout": (prev)=>prev + 1
                        }["OrchestratorPage.useEffect.timeout"]);
                    } else {
                        setIsRunning(false);
                    }
                }
            }["OrchestratorPage.useEffect.timeout"], stepDuration * 1000);
            return ({
                "OrchestratorPage.useEffect": ()=>{
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                fileName: "[project]/src/app/project/[id]/orchestrator/page.tsx",
                                lineNumber: 135,
                                columnNumber: 11
                            }, this),
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                className: "text-2xl sm:text-3xl font-bold text-[var(--ink)]",
                                children: isRtl ? "التوليد الذكي" : "AI Generation"
                            }, void 0, false, {
                                fileName: "[project]/src/app/project/[id]/orchestrator/page.tsx",
                                lineNumber: 138,
                                columnNumber: 11
                    ...
                    !isRunning && currentStep === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        onClick: handleStart,
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                            ...
                                            children: isRtl ? "خط زمني الوكلاء" : "Agent Timeline"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/project/[id]/orchestrator/page.tsx",
                                            lineNumber: 158,
                                            columnNumber: 15
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: steps.map((step, index)=>{
                                                ...
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                                    ...
                                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex items-center gap-4 p-4 rounded-[var(--radius-md)] border transition-all", isCompleted ? "bg-[rgba(27,107,97,0.08)] border-[var(--accent-3)]" : isCurrent ? "bg-[rgba(15,76,129,0.08)] border-[var(--accent)] shadow-md" : "bg-[var(--surface-2)] border-[var(--line)]"),
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("w-10 h-10 rounded-full flex items-center justify-center", isCompleted ? "bg-[var(--accent-3)] text-white" : isCurrent ? "bg-[var(--accent)] text-white" : "bg-[var(--bg-2)] text-[var(--ink-faint)]"),
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("font-semibold", isCompleted || isCurrent ? "text-[var(--ink)]" : "text-[var(--ink-soft)]"),
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    ...
                                                                    children: isCompleted ? isRtl ? "مكتمل" : "Completed" : isCurrent ? isRtl ? "جاري التنفيذ..." : "Processing..." : `~${step.duration}s`
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/project/[id]/orchestrator/page.tsx",
                                                                    lineNumber: 211,
                                                                    columnNumber: 25
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                            className: "text-lg font-bold text-[var(--ink)] mb-4",
                                            children: isRtl ? "سجل القرارات" : "Decision Feed"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/project/[id]/orchestrator/page.tsx",
                                            lineNumber: 240,
                                            columnNumber: 15
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                                                children: decisions.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-[var(--ink-soft)] text-sm text-center py-8",
                                                    children: isRtl ? "ابدأ التوليد لرؤية القرارات" : "Start generation to see decisions"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/project/[id]/orchestrator/page.tsx",
                                                    lineNumber: 246,
                                                    columnNumber: 21
                                                }, this) : decisions.map((decision, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                                        initial: {
                                                            opacity: 0,
                                                            x: -20
                                                        },
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                children: isRtl ? decision.messageAr : decision.message
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/project/[id]/orchestrator/page.tsx",
                                                                lineNumber: 260,
                                                                columnNumber: 25
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                            className: "text-lg font-bold text-[var(--ink)] mb-4",
                                            children: isRtl ? "المقاييس المباشرة" : "Live Metrics"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/project/[id]/orchestrator/page.tsx",
                                            lineNumber: 276,
                                            columnNumber: 15
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            className: "text-xs text-[var(--ink-faint)] mt-1",
                                                            children: [
                                                                metrics.energyIntensity.toFixed(0),
                                                                " kWh/m²/yr"
                                                            ]
                                                        }, void 0, true, {
                                                            fileName: "[project]/src/app/project/[id]/orchestrator/page.tsx",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        ...
                                        isRunning && currentStep > 2 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "space-y-2",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "flex items-center gap-2 p-3 bg-[rgba(179,107,45,0.1)] rounded-[var(--radius-sm)] border border-[rgba(179,107,45,0.2)]",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                        variant: "warning",
                                                        children: "MEP"
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: isRtl ? "تداخل مجرى مع عمود" : "Duct intersects with column"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/project/[id]/orchestrator/page.tsx",
                                                        lineNumber: 330,
                                                        columnNumber: 21
                                            ...
                                            className: "text-sm text-[var(--ink-soft)] text-center py-4",
                                            children: isRtl ? "لا توجد تعارضات" : "No conflicts detected"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/project/[id]/orchestrator/page.tsx",
                                            lineNumber: 338,
                                            columnNumber: 17
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("w-16 h-16 rounded-full mx-auto mb-3 flex items-center justify-center", isRunning ? "bg-[rgba(15,76,129,0.1)]" : currentStep >= steps.length - 1 ? "bg-[rgba(27,107,97,0.1)]" : "bg-[var(--bg-2)]"),
                                            children: isRunning ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                                                ...
                                                lineNumber: 359,
                                                columnNumber: 19
                                            }, this) : currentStep >= steps.length - 1 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Check$3e$__["Check"], {
                                                className: "w-8 h-8 text-[var(--accent-3)]"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/project/[id]/orchestrator/page.tsx",
                                                lineNumber: 361,
                                                columnNumber: 19
                                            }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$clock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Clock$3e$__["Clock"], {
                                                className: "w-8 h-8 text-[var(--ink-faint)]"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/project/[id]/orchestrator/page.tsx",
                                                lineNumber: 363,
                                                columnNumber: 19
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: isRunning ? isRtl ? "جاري التوليد..." : "Generating..." : currentStep >= steps.length - 1 ? isRtl ? "اكتمل التوليد" : "Generation Complete" : isRtl ? "جاهز للبدء" : "Ready to Start"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/project/[id]/orchestrator/page.tsx",
                                            lineNumber: 366,
                                            columnNumber: 15
...
_s(OrchestratorPage, "ZMShMGkMMF+PeqhmwbqR5KN/WY4=", false, function() {
    return [
...
_c = OrchestratorPage;
var _c;
__turbopack_context__.k.register(_c, "OrchestratorPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_2c1d35a8._.js.map